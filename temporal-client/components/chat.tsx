...
import { useResearchPolling } from "@/hooks/use-research-polling";
...
import { ResearchActivityMonitor } from "./research-activity-monitor";
...
export function Chat({
  ...
  useEffect(() => {
    if (activeWorkflowId && !showActivityMonitor) {
  ...
  //   enabled: false, // Disabled - using blocking approach
  //   onUpdate: () => {
  //     console.log('🔄 CHAT COMPONENT - Research polling triggered update callback');
  //     console.log('- Action: Refreshing page to show updated document');
